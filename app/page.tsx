  ...
  return (
    <div className="page">
      <div className="card w-full max-w-4xl p-10 md:p-14">
        <h1 className="text-3xl md:text-4xl font-semibold tracking-tight">Kiểm tra độ mạnh yếu mật khẩu</h1>

        <div className="mt-8">
          <label className="block text-sm font-medium text-slate-700 mb-2">Mật khẩu</label>
          <input
            type="password" name="pwd-demo" autoComplete="new-password" autoCorrect="off" spellCheck={false}
            inputMode="text" data-lpignore="true" data-1p-ignore="true" placeholder="Nhập mật khẩu của bạn"
            className="input" value={pw} onChange={(e)=>setPw(e.target.value)}
          />
